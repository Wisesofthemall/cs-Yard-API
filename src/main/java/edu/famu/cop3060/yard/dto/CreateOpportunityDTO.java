...
/**
 * Request body for POST /api/opportunities. Contains all fields required to create
 * a new opportunity. The application generates the ID when the record is created.
 */
